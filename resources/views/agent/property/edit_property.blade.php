...
<input type="checkbox" name="featured" value="1" class="form-check-input" id="checkInline1" {{$property->featured == 1 ? 'checked' : ''}}>
         ...
         <div class="form-check form-check-inline">
<input type="checkbox" name="hot" value="1" class="form-check-input" id="checkInline" {{$property->featured == 1 ? 'checked' : ''}}>
...
<div class="card-body">
    <h6 class="card-title">Edit Multi Images </h6>
        ...
        <form method="post" action="{{ route('agent.update.property.multiimage') }}" id="myForm" enctype="multipart/form-data">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <a href="{{ route('agent.delete.property.multiimage',$img->id) }}" class="btn btn-danger" id="delete">Delete </a>
                            </td>
                        </tr>
                        @endforeach       
                    </tbody>
        ...
        <form method="post" action="{{ route('agent.store.new.multiimage') }}" id="myForm" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="multiImgId" value="{{$property->id}}">
            <table class="table table-striped">
                <tbody>
                    <tr>
                        <td>
...
<!--    /// End  Property Multi Images Update //// -->
