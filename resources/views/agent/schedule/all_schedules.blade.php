...
<div class="page-content">
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">All Schedule Requests </h6>
               ...
               <span class="badge rounded-pill bg-danger">Pending</span>
                      @endif
                        ...
                        <td>
                          <a href="{{ route('agent.schedule.details',$item->id) }}" class="btn btn-inverse-info" title="Details"><i data-feather="eye"></i></a>
