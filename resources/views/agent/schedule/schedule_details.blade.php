...
<div class="card">
    ...
    <form method="POST" action="{{route('agent.schedule.confirm')}}">
        @csrf
        ...
        <br><br>
        <button type="submit" class="btn btn-success" style="margin-left: 3%">Request Confirm</button>
        <br><br>
    </form>
</div>
        </div>
