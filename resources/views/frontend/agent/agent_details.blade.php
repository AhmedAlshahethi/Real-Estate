            ...
            <div class="agents-block-one">
                <div class="inner-box mr-0">
                    <figure class="image-box"><img src="{{ (!empty($agent->photo)) ? url('upload/agent_images/'.$agent->photo) : url('upload/no_image.jpg') }}" 
                       style="width: 270px; height: 330px;" alt=""></figure>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="other-info-box clearfix">
                                        <div class="btn-box pull-left"><a href="{{route('property.details',[$item->id, $item->property_slug])}}" class="theme-btn btn-two">See Details</a></div>
                        ...
                        <div class="form-inner">
                            <form action="{{route('agent.message')}}" method="post" class="default-form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="msg_name" value="{{$userData->name}}">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="msg_email" value="{{$userData->email}}">
                                </div>
                                <div class="form-group">
                                    <input type="tel" name="msg_phone" value="{{$userData->phone}}">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="agents-contact sidebar-widget">
                        ...
                        <div class="form-inner">
                            <form action="{{route('agent.message')}}" method="post" class="default-form">
                                ...
                                <div class="form-group">
                                    <input type="email" name="msg_email" placeholder="Email Address" required="">
                                </div>
                                <div class="form-group">
                                    <input type="tel" name="msg_phone" placeholder="Phone" required="">
                                </div>
                                <div class="form-group">
                                    <textarea name="message" placeholder="Your Message"></textarea>
                                </div>
                    ...
                    <div class="featured-widget sidebar-widget">
                        ...
                        <div class="single-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                            ...
                            <div class="feature-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="{{asset($fea->property_thambnail)}}" 
                                           style="width: 370px; height: 250px;" alt=""></figure>
                                        <div class="batch"><i class="icon-11"></i></div>
                                        <span class="category">Featured</span>
                                    </div>
                                    <div class="lower-content">
                                        <div class="title-text"><h4><a href="{{route('property.details',[$fea->id, $fea->property_slug])}}">{{$fea->property_name}}</a></h4></div>
                                        <div class="price-box clearfix">
                                            <div class="price-info">
                                                <h6>Start From</h6>
                                                <h4>${{$fea->lowest_price}}</h4>
                                            </div>
                                        </div>
                                        <p>{{$fea->short_descp}}</p>
                                        <div class="btn-box"><a href="{{route('property.details',[$fea->id, $fea->property_slug])}}" class="theme-btn btn-two">See Details</a></div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
