...
<li><a href="{{route('user.schedule.request')}}"><i class="fa fa-credit-card" aria-hidden="true"></i> Schedule Requests<span class="badge badge-info"></span></a></li>
<li><a href="{{route('user.comparelist')}}"><i class="fa fa-list-alt" aria-hidden="true"></i></i> Comparelist </a></li>
