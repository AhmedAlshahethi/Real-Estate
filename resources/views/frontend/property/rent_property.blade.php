                            ...
                            <div class="widget-content">
                                <div class="select-box">
                                    <select name="property_status" class="wide">
                                       <option data-display="Status">Select Property Status</option>
                                ...
                                <div class="select-box">
                                    <select name="ptype_id" class="wide">
                                       <option data-display="Type" selected="" disabled="">Select Property Type</option>
