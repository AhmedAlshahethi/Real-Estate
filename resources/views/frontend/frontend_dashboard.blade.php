...
<body>
    ...
    <script src="{{ asset('backend/assets/js/code/toastr.js') }}"></script>

    <script src="{{ asset('backend/assets/js/code/sweetalert2.js') }}"></script>
...
<script type="text/javascript">
  ...
  // Add To comparelist 
  function addToCompareList(property_id){
    $.ajax({
            type: "POST",
            dataType: 'json',
            url: "/add-to-compareList/"+property_id,
            success:function(data){
                // Start Message 
            const Toast = Swal.mixin({
                  toast: true,
...
<script type="text/javascript">
              ...
              $.each(response, function(key,value){
                rows += `<tr>
                        ...
                        <tr>
                            ...
                            <td>
                              <a type="submit" class="text-body" id="${value.id}" onclick="compareListtRemove(this.id)" ><i class="fa fa-trash"></i></a>
                            </td>  
                        </tr>`  
              });
  ...
  function compareListtRemove(id){
        $.ajax({
            type: "GET",
            dataType: 'json',
