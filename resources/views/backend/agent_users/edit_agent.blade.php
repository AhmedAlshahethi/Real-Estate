...
<div class="page-content">
 ...
 <label for="exampleInputEmail1" class="form-label">Agent Name  </label>
					 <input type="text" name="name" value="{{$agentData->name}}" class="form-control @error('name') is-invalid @enderror " >
           @error('name')
 ...
 <label for="exampleInputEmail1" class="form-label">Agent Username   </label>
					 <input type="text" name="username" value="{{$agentData->username}}"class="form-control @error('username') is-invalid @enderror " >
           @error('username')
           <span class="text-danger">{{ $message }}</span>
           @enderror
				</div> 
 ...
 <label for="exampleInputEmail1" class="form-label">Agent Email   </label>
					 <input type="email" name="email" value="{{$agentData->email}}" class="form-control @error('email') is-invalid @enderror " >
           @error('email')
           <span class="text-danger">{{ $message }}</span>
           @enderror
				</div>
 ...
 <label for="exampleInputEmail1" class="form-label">Agent Phone   </label>
					 <input type="text" name="phone" value="{{$agentData->phone}}" class="form-control @error('phone') is-invalid @enderror " >
           @error('phone')
           <span class="text-danger">{{ $message }}</span>
           @enderror
				</div>
 ...
 <label for="exampleInputEmail1" class="form-label">Agent Address   </label>
					 <input type="text" name="address" value="{{$agentData->address}}" class="form-control @error('address') is-invalid @enderror " >
           @error('address')
           <span class="text-danger">{{ $message }}</span>
           @enderror
				</div>
