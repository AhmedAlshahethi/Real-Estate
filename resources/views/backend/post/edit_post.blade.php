...
<div class="page-content">
        ...
        <div class="row profile-body">
          ...
          <div class="col-md-12 col-xl-12 middle-wrapper">
			...
			<form method="POST" action="{{ route('update.blog.post') }}" enctype="multipart/form-data" class="forms-sample">
				@csrf
				...
				<div class="row">
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="post_title" value="{{$blogpost->post_title}}" class="form-control"  >
                        </div>
                    </div><!-- Col -->
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input name="post_tags" id="tags" value="{{$blogpost->post_tags}}" />
                        </div>
                    </div><!-- Col -->
           ...
           @enderror
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">    </label>
                       <img id="showImage" class="wd-80 rounded-circle" src="{{ asset($blogpost->post_image) }}" alt="profile">
                </div>
