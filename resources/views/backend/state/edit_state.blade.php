...
<div class="page-content">
        ...
        <div class="row profile-body">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<form method="POST" action="{{ route('update.state') }}" enctype="multipart/form-data" class="forms-sample">
				@csrf
 ...
 <label for="exampleInputEmail1" class="form-label">State Name   </label>
					 <input type="text" name="state_name" value="{{$state->state_name}}" class="form-control @error('state_name') is-invalid @enderror" >
           @error('state_name')
